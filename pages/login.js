                ...
                <Container
                    ...
                    <Stack spacing={{ base: 10, md: 20 }}>
                        ...
                        <Stack direction={'row'} spacing={4} align={'center'}>
                            ...
                            <Text fontFamily={'heading'} fontSize={{ base: '4xl', md: '6xl' }} color='gray.400'>
                                +
                            </Text>
                            <Flex
                                align={'center'}
                    ...
                    <Stack
                        ...
                        <Stack spacing={4}>
                            ...
                            <Box d='flex' alignItems='center'>
                                <Heading
                                    lineHeight={1.1}
                                    fontSize={{ base: '2xl', sm: '3xl', md: '4xl' }} d='inline' fontWeight='black' color='gray.700'>
                                    Login to
                                </Heading>
                                <Img
                                    src='/logo.png'
                            ...
                            <Box bg='red.100' rounded='md' p={3}>
                                ...
                                <Box>
                                    <Text fontWeight="bold" d='inline'>Password:</Text> hello123
                                </Box>
                            </Box>
                        </Stack>
                        <Formik
